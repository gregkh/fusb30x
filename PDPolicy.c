...
/////////////////////////////////////////////////////////////////////////////
extern UINT16                   Timer_S;                                        // Tracks seconds elapsed for log timestamp
extern UINT16                   Timer_tms;                                      // Tracks tenths of milliseconds elapsed for log timestamp
...
void PolicySourceTransitionDefault(void)
{
    switch (PolicySubIndex)
    {
        case 0:
            ...
            while(!VbusVSafe0V());                                               // Allow the voltage to drop to 0
            PolicySubIndex++;
    ...
    switch(PolicySubIndex)
    {
        ...
        case 2: // Wait for tSnkTransition and then turn off power (and Rd on/Rp off)
            if (!PolicyStateTimer)
            {
                ...
                PolicyStateTimer = 0; //tPSSourceOffNom;//TODO: PRSwap Restructure                             // Allow the output voltage to fall before sending the PS_RDY message
    ...
    switch (PolicySubIndex)
    {
        ...
        case 1:
            if(PolicyStateTimer == 0)                                                   // Transition to SRC_Transition_to_Default, SNK_Transition_to_Default, or CBL_Ready when BISTContModeTimer times out
            {
                ...
                {
                    // TODO: Fix SourceTransitionToDefault to match spec
...
BOOL GetPDStateLog(UINT8 * data){   // Loads log into byte array
    UINT32 i;
