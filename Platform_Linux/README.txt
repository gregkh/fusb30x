...
Device Tree
	Currently, the driver requires the use of Device Tree in order to function with the I2C bus and the required GPIO pins. Modify the following Device Tree snippet to specify resources specific to your system and include them in your kernel's Device Tree. The FUSB302 requires a minimum of 2 GPIO pins, a valid I2C bus, and I2C slave address 0x22.
	/*****************************************************************************/
...
Compilation/Makefile
	You must define the preprocessor macro "PLATFORM_LINUX" in order to pull in the correct typedefs.
	The following example snippet is from a Makefile with the following directory structure:
		/*****************************************************************************/
		path/to/MakefileDir/
			|---- Makefile
			|---- Platform_Linux/
